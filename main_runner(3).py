...
MODEL = "yolov8n.pt"
CONF = 0.6
CLASSES = { "person": 0, "car": 2, "dog": 16, "cat": 15, "bicycle": 1, "motorcycle": 3, "bottle": 39 }
...
git commit -m "Refactor main runner variables to match final style"