...
def main():
    ...
    print(f"  Tracking Mode: {cfg['mode']}")
    ...
    while True:
        ...
        iy += 20
        cv2.putText(disp, f"FPS: {afps:.1f}", (10, iy), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 1)
        iy += 20
        if auto:
...
git commit -m "Improve startup feedback and add main exception handling"